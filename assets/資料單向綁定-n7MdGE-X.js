import{j as n}from"./index-CKLcwRDI.js";import{u as s}from"./useTheme-BufUxuuL.js";import{h as e,t as l,a}from"./tomorrow-CHhCJzDP.js";import"./toConsumableArray-Cg7-Q_9P.js";function c(){const i=s();return n.jsx(n.Fragment,{children:n.jsx("div",{children:n.jsxs("section",{children:[n.jsx("h3",{children:"開啟功能"}),n.jsx("ul",{children:n.jsxs("li",{children:["需在build.gradle.kts (Module :app)中加入",n.jsx("br",{}),n.jsx(e,{language:"kotlin",style:i==="dark"?l:a,children:`buildFeatures {
    compose = true
    dataBinding = true
