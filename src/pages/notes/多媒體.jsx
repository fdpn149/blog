            ...
            <section>
                <details>
                    ...
                    <details>
                        ...
                        <Image path='/notes/多媒體/1' style={{ 'max-width': 'min(100%, 20rem)' }} />
                    </details>
                    <details>
                        ...
                        <Image path='/notes/多媒體/2' style={{ 'max-width': 'min(100%, 20rem)' }} />
                        <Image path='/notes/多媒體/3' style={{ 'max-width': 'min(100%, 20rem)' }} />
                    </details>
                </details>
                <details>
                    ...
                    <ul>
                        ...
                        <li>眼睛視網膜對顏色的敏感度：G:R:B=4:2:1
                            <br />
                            <Image path='/notes/多媒體/4' style={{ 'max-width': 'min(100%, 10rem)' }} />
                        </li>
                        <li>三種視錐細胞(receptors) 在不同的波長，會受到不同的刺激
                            <br />
                            <Image path='/notes/多媒體/5' style={{ 'max-width': 'min(100%, 20rem)' }} />
                            <ul>
                ...
                <details>
                    ...
                    <Image path='/notes/多媒體/6' style={{ 'max-height': '12rem' }} />
                    <Image path='/notes/多媒體/7' style={{ 'max-height': '12rem' }} />
                    <details>
                        <summary><h3>RGB & CMYK</h3></summary>
                        <details>
                            <summary><h3>RGB</h3></summary>
                            <Image path='/notes/多媒體/8' style={{ 'max-width': 'min(100%, 15rem)' }} />
                            <Image path='/notes/多媒體/9' style={{ 'max-width': 'min(100%, 15rem)' }} />
                            <ul>
