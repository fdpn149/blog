...
function RadixTypeSel({ setRadixType }) {
    ...
    const colourStyles = {
        control: (base, state) => ({
            ...
            borderColor: state.isFocused ? '#3b82f6' : (theme === 'dark' ? 'rgba(255, 255, 255, 0.2)' : 'rgba(0, 0, 0, 0.2)'),
            borderRadius: '8px',
            boxShadow: state.isFocused ? '0 0 0 2px rgba(59, 130, 246, 0.2)' : 'none',
            '&:hover': {
                borderColor: state.isFocused ? '#3b82f6' : (theme === 'dark' ? 'rgba(255, 255, 255, 0.3)' : 'rgba(0, 0, 0, 0.3)')
            },
            padding: '4px',
        ...
        option: (base, state) => ({
            ...
            fontFamily: 'var(--code-font, monospace)',
            '&:active': {
                backgroundColor: state.isSelected ? '#2563eb' : (theme === 'dark' ? 'rgba(255, 255, 255, 0.15)' : 'rgba(0, 0, 0, 0.1)')
            }
        }),
        singleValue: (base) => ({
            ...base,
